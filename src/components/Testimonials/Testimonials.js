      ...
      <div class="container py-5">
        ...
        <div class="row d-flex justify-content-center align-items-center">
          ...
          <div class="col-lg-6 mt-5 mt-lg-0 mt-5">
            ...
            <h3 class="column-title">
              <a href="#" style={{ color: "white" }}>
                Royal Bengal Real Estate LLC Properties, discover an array of
                options featuring exceptional properties for sale in Dubai,
                spanning across various sizes and price ranges. Our collection
                caters to diverse preferences, ensuring there's a perfect match
