...
<section id="main-container" class="main-container">
  <div class="container ">
    ...
    <div
            class="col-12 col-sm-12 col-md-6 col-lg-6 text-light"
         
          >
            <div class="p-3    ">
              <img
                src="http://localhost:3000/images/news/news2.jpg"
                alt="" className="img-fluid rounded-2 border"
              />
            </div>
          </div>

<div class="col-lg-6  ">
          <h3 class="column-title mt-2" style={{color:"#BC4B26"}}>Who We Are</h3>
